...
$search_stmt = $assignment->dashboardAssignment($searchString, $searchColumn);
...
if ($search_stmt['outputStatus'] == 1000) {
    ...
    // echo json_encode(array("message" => $search_stmt,"status" => 999));
    // return;

    $search_result = $search_stmt['output']->fetchAll(PDO::FETCH_ASSOC);

    // http_response_code(404);
    // echo json_encode(array("message" => $search_result,"status" => 99));
    // return;
