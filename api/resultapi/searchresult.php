...
$search_stmt = $result->searchresult($searchString, $searchColumn);
...
if ($search_stmt['outputStatus'] == 1000) {
    ...
    if (count($search_result) == 0) {
        ...
        // tell the result
        echo json_encode(array("message" => "No result found for this search word : $searchString", "status" => 0));
        return;
    }
    ...
    // tell the result
    echo json_encode(array("message" => "No result found for this search item", "status" => 200));
}
