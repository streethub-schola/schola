...
if ((empty($role_id) || $role_id == null || !is_numeric($role_id) ||  $role_id == ' ')) {
    // No valid role id provided

    // set response code - 404 Not found
    http_response_code(404);

    // tell the role no products found
    echo json_encode(
        array("message" => "Plaese provide a valid role ID")
    );
